    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url('Auth/input_register'); ?>" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="number" class="form-control" placeholder="Nomor WhatsApp" name="nomorwhatsapp">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                    <div class="form-control">
                      <!-- <div class="row"> -->
                        <!-- <div class="col-md-3"> -->
                            <label for="roles">Prodi   : </label>
                            <select class="form-group has-feedback" id="roles" name="roles">Pilih Prodi
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="NIM Anggota 3" name="nimteman2">
            <span class="fa fa-users form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="NIM Anggota 4" name="nimteman2">
            <span class="fa fa-users form-control-feedback"></span>
          </div>
          <div class="row">
            <!-- <div class="col-xs-8">
