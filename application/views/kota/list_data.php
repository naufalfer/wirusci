<?php
  ...
  foreach ($dataJawaban as $jawaban) {
    ...
    <tr>
      <td><?php echo $no; ?></td>
      <td><?php echo $jawaban->username; ?></td>
      <td class="text-center" style="min-width:230px;">
          <button class="btn btn-warning update-dataJawaban" data-id="<?php echo $jawaban->id; ?>"><i class="glyphicon glyphicon-repeat"></i> Update</button>
